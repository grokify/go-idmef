...
var xmlExampleTests = []struct {
	...
	{"example_local-attacks_loadmodule-attack.xml", testdata.ExampleLocalAttacksLoadModuleAttack},
	{"example_local-attacks_loadmodule-root-user-attack.xml", testdata.ExampleLocalAttacksLoadModuleRootUserAttack},
